...
def main():
    ...
    parser.add_argument('--vep_vcf', required=False, default='[vcfDir]/[SeqID].[VcfTag].vep.refseq.vcf', help='No description (Default: [vcfDir]/[SeqID].[VcfTag].vep.refseq.vcf)')
    parser.add_argument('--vep_stats', required=False, default='[vcfDir]/[SeqID].[VcfTag].vep.refseq.vcf_summary.txt', help='No description (Default: [vcfDir]/[SeqID].[VcfTag].vep.refseq.vcf_summary.txt)')
