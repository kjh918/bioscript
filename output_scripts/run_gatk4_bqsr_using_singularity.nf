...
process GATK4 {
    ...
    input:
    tuple val(sample_id), val(SeqID), path(BamDir), val(qcResDir), val(ReferenceFasta), val(KnownSnp1), val(KnownSnp2), val(KnownIndel1), val(KnownIndel2)
    ...
    def KnownSnp1 = params.KnownSnp1 ?: ""
    def KnownSnp2 = params.KnownSnp2 ?: ""
    def KnownIndel1 = params.KnownIndel1 ?: ""
    def KnownIndel2 = params.KnownIndel2 ?: ""
    def InputSuffix = params.InputSuffix ?: "merged.dup.marked.realign"
    def OutputSuffix = params.OutputSuffix ?: "merged.dup.marked.realign.recal"
