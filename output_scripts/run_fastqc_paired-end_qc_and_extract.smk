...
rule fastqc:
    ...
    shell:
        """
        {params.singularity_bin} exec -B {params.bind} {params.sif} {params.fastqc_bin} {params.fastqc_args} --threads {threads} --outdir {input.qcResDir} {input.RawFastqDir}/{input.SeqID}_R1{params.InputSuffix} {input.RawFastqDir}/{input.SeqID}_R2{params.InputSuffix}
        """