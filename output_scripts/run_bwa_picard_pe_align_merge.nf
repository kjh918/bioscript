...
process BWA_PICARD {
    ...
    def soft_clipping = params.soft_clipping ?: ""
    def clipping_penalty = params.clipping_penalty ?: ""
    ...
    def mba_other_flags = params.mba_other_flags ?: "--INCLUDE_SECONDARY_ALIGNMENTS true --ADD_MATE_CIGAR true --CREATE_INDEX true --MAX_INSERTIONS_OR_DELETIONS -1 --CLIP_ADAPTERS false --CLIP_OVERLAPPING_READS true"
    """
