...
usage() {
    ...
    echo "  --vep_vcf         No description (Default: [vcfDir]/[SeqID].[VcfTag].vep.ensembl.vcf)"
    echo "  --vep_stats       No description (Default: [vcfDir]/[SeqID].[VcfTag].vep.ensembl.vcf_summary.txt)"
