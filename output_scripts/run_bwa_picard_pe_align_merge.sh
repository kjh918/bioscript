...
usage() {
    ...
    echo "  --soft_clipping   No description (Default: )"
    echo "  --clipping_penalty No description (Default: )"
    ...
    echo "  --mba_other_flags No description (Default: --INCLUDE_SECONDARY_ALIGNMENTS true --ADD_MATE_CIGAR true --CREATE_INDEX true --MAX_INSERTIONS_OR_DELETIONS -1 --CLIP_ADAPTERS false --CLIP_OVERLAPPING_READS true)"
...
mba_other_flags="--INCLUDE_SECONDARY_ALIGNMENTS true --ADD_MATE_CIGAR true --CREATE_INDEX true --MAX_INSERTIONS_OR_DELETIONS -1 --CLIP_ADAPTERS false --CLIP_OVERLAPPING_READS true"
