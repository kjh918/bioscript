...
ALL_KEYS = ['SeqID', 'BamDir', 'qcResDir', 'bind', 'sif', 'gc_threads', 'xmx_mb', 'gatk_jar', 'java_bin', 'alignment_summary_metrics_txt']
REQUIRED = {'SeqID': True, 'BamDir': True, 'qcResDir': True, 'alignment_summary_metrics_txt': False}
...
OUTPUTS_META = {'alignment_summary_metrics_txt': {'default': '[qcResDir]/[SeqID].alignment.summary.metrics.txt'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: gatk4 4.4.0.0 (singularity_qc_alignment_summary)",
