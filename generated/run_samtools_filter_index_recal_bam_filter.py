...
ALL_KEYS = ['SeqID', 'BamDir', 'Threads', 'min_mapq', 'include_flag', 'exclude_flag1', 'exclude_flag2', 'expr_sclen', 'expr_nm', 'filtered_bam', 'filtered_bai']
REQUIRED = {'SeqID': True, 'BamDir': True, 'filtered_bam': False, 'filtered_bai': False}
DEFAULTS = {'Threads': '8', 'min_mapq': '20', 'include_flag': '0x2', 'exclude_flag1': '0x100', 'exclude_flag2': '0x4', 'expr_sclen': 'sclen < 20', 'expr_nm': '[NM] < 12', 'filtered_bam': '[BamDir]/[SeqID].recal.filtered.bam', 'filtered_bai': '[BamDir]/[SeqID].recal.filtered.bam.bai'}
OUTPUTS_META = {'filtered_bam': {'default': '[BamDir]/[SeqID].recal.filtered.bam'}, 'filtered_bai': {'default': '[BamDir]/[SeqID].recal.filtered.bam.bai'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: samtools_filter_index 1.10 (recal_bam_filter)",
