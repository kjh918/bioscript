...
ALL_KEYS = ['SeqID', 'BamDir', 'Threads', 'sorted_bam', 'sorted_bai']
REQUIRED = {'SeqID': True, 'BamDir': True, 'sorted_bam': False, 'sorted_bai': False}
DEFAULTS = {'Threads': '8', 'sorted_bam': '[BamDir]/[SeqID].sorted.bam', 'sorted_bai': '[BamDir]/[SeqID].sorted.bam.bai'}
OUTPUTS_META = {'sorted_bam': {'default': '[BamDir]/[SeqID].sorted.bam'}, 'sorted_bai': {'default': '[BamDir]/[SeqID].sorted.bam.bai'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: samtools 1.10 (bam_sort_index)",
