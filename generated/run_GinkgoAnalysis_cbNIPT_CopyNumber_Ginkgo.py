...
ALL_KEYS = ['SeqID', 'ReadLength', 'ResultBaseDir', 'threads', 'BinSizeList', 'GinkgoScript', 'FinalResultRoot']
REQUIRED = {'SeqID': True, 'ReadLength': True, 'ResultBaseDir': False, 'FinalResultRoot': False}
DEFAULTS = {'threads': '1', 'BinSizeList': '100 150 200 250', 'GinkgoScript': '/storage/home/kangsm/runScripts/cbNIPT/GCX.cbNIPT_Run.Ginkgo.Analysis.sh', 'FinalResultRoot': '[ResultBaseDir]/[SeqID]'}
OUTPUTS_META = {'FinalResultRoot': {'default': '[ResultBaseDir]/[SeqID]'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: GinkgoAnalysis 1.0.0 (cbNIPT_CopyNumber_Ginkgo)",
