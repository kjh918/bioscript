...
ALL_KEYS = ['SeqID', 'BamDir', 'qcResDir', 'ReferenceFasta', 'bind', 'sif', 'gc_threads', 'xmx_mb', 'gatk_jar', 'java_bin', 'wgs_metrics_txt']
REQUIRED = {'SeqID': True, 'BamDir': True, 'qcResDir': True, 'ReferenceFasta': True, 'wgs_metrics_txt': False}
DEFAULTS = {'bind': '/storage,/data', 'sif': '/storage/images/gatk-4.4.0.0.sif', 'gc_threads': '14', 'xmx_mb': '16384', 'gatk_jar': '/gatk/gatk-package-4.4.0.0-local.jar', 'java_bin': 'java', 'wgs_metrics_txt': '[qcResDir]/[SeqID].collect.wgs.metrics.txt'}
OUTPUTS_META = {'wgs_metrics_txt': {'default': '[qcResDir]/[SeqID].collect.wgs.metrics.txt'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: gatk4 4.4.0.0 (singularity_qc_wgs_metrics)",
