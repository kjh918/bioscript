...
ALL_KEYS = ['SeqID', 'BamDir', 'qcResDir', 'ReferenceFasta', 'bind', 'sif', 'gc_threads', 'xmx_mb', 'gatk_jar', 'java_bin', 'lc_all', 'insert_size_metrics_txt', 'insert_size_hist_pdf']
REQUIRED = {'SeqID': True, 'BamDir': True, 'qcResDir': True, 'ReferenceFasta': True, 'insert_size_metrics_txt': False, 'insert_size_hist_pdf': False}
...
OUTPUTS_META = {'insert_size_metrics_txt': {'default': '[qcResDir]/[SeqID].insert.size.metrics.txt'}, 'insert_size_hist_pdf': {'default': '[qcResDir]/[SeqID].insert.size.histogram.pdf'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: gatk4 4.4.0.0 (singularity_qc_insert_size)",
