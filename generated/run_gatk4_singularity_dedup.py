...
ALL_KEYS = ['SeqID', 'BamDir', 'qcResDir', 'bind', 'sif', 'gc_threads', 'xmx_mb', 'md_args', 'dedup_bam', 'dedup_bai', 'metrics_txt']
REQUIRED = {'SeqID': True, 'BamDir': True, 'qcResDir': True, 'dedup_bam': False, 'dedup_bai': False, 'metrics_txt': False}
...
OUTPUTS_META = {'dedup_bam': {'default': '[BamDir]/[SeqID].sorted.dedup.bam'}, 'dedup_bai': {'default': '[BamDir]/[SeqID].sorted.dedup.bam.bai'}, 'metrics_txt': {'default': '[qcResDir]/[SeqID].mark.duplicates.metrics.txt'}}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Runner: gatk4 4.4.0.0 (singularity_dedup)",
