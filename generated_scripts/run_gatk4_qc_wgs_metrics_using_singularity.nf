...
process GATK4 {
    ...
    """
    ${singularity_bin} exec -B ${bind} ${sif} ${java_bin} -XX:ParallelGCThreads=${Threads} -Xmx${xmx_mb}m -jar ${gatk_jar} CollectWgsMetrics --INPUT ${BamDir}/${SeqID}.${InputSuffix}.bam --OUTPUT ${wgs_metrics_txt} --REFERENCE_SEQUENCE ${ReferenceFasta}
    """
}