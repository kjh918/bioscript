...
def main():
    ...
    for k in ['BamDir', 'ReadGroupCenter', 'ReadGroupID', 'ReadGroupLibrary', 'ReadGroupPlatform', 'ReferenceFasta', 'SeqID', 'Threads', 'TmpDir', 'TrimFastqDir', 'aligned_sam', 'bind', 'bwa_args', 'bwa_sif', 'java_bin', 'mba_args', 'picard_jar', 'primary_bai', 'primary_bam', 'unmapped_bam', 'xmx_mb']:
