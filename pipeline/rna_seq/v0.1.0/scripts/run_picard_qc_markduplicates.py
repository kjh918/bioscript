...
def main():
    ...
    parser.add_argument('--remove_duplicates', required=False, default='false', help='If true, removes duplicates completely rather than just marking them (Default: false)')
