...
def main():
    ...
    parser_cnv.add_argument('--SmoothWindow', type=int, default=4, help='Rolling median window size')
    parser_cnv.add_argument('--MinDepth', type=float, default=2, help='최소 Depth')
    parser_cnv.add_argument('--MinCoverage', type=float, default=0.2, help='최소 Coverage 비율')
