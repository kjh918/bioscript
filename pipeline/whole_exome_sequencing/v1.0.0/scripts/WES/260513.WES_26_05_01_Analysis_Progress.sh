...
### Lab-Genomic File Treat -------------------------------------------------------------------------
    ...
    #    --WES_BatchID WES_26_05 --LabGenomicsDataDir /data/ngs/lab_genomics.ngs_ruo_service/2025-12-30/251226_gencurix
###        
### CREATE PROJECT ---------------------------------------------------------------------------------
    Rscript /storage/home/jhkim/Projects/NGS/WES/v1/NGS_service.CreateProject.R \
        ...
        --BATCH_ID "WES_26_01" \
        --CLIENT_ID 15 \
        --SAMPLE_INFO_FILE "WES_26_01_seqid_info.260526.xlsx" \
...
#    qsub -q all.q@ngsnode1 /storage/home/kangsm/myScripts/Analysis/142_GCX-C15-251126_WES_26_05/WES_26_05_wes_SeqID_Processing_TumorOnly_Analysis_500X.sh
    #qsub -q all.q@ngsmaster /storage/home/kangsm/myScripts/Analysis/142_GCX-C15-251126_WES_26_05/WES_26_05_wes_SeqID_Processing_TumorOnly_Analysis_100X.sh
####
#### Individual Matching ----------------------------------------------------------------------------
...
#    qsub -q all.q@ngsnode1 /data/wes/WES_26_05/meta/WES_26_05_wes_SampleGroup_MatchedNormal_Analysis.sh
####

#### ANALYSIS 
#    cp /storage/home/kangsm/myScripts/Default_Scripts/DEFAULT_wes_report_config.yaml /data/wes/WES_26_05/meta/wes_report_config.yaml
#    ln -s /data/wes/WES_26_05/meta/wes_report_config.yaml /storage/home/kangsm/myScripts/Analysis/142_GCX-C15-251126_WES_26_05/wes_report_config.yaml
    
#    Rscript /storage/home/kangsm/runScripts/WES_run.ReportAnalysis_OrganoidScience.R \
#        --BASE_DIR "/data/wes" --SEQ_FOLDER "WES_26_05" --PRESET_RDS "preset.genes_organoid.science.rds" \
...
#    ID_LIST_FILE=/data/wes/WES_26_05/meta/WES_26_05_export_data.list
#    EXPORT_DIR=/data/wes/WES_26_05/export_data
#    DATA_DIR=/data/wes/WES_26_05
