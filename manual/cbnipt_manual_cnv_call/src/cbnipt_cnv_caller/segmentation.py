    ...
    for chrom in chrom_list:
        ...
        for bp in bkps:
            ...
            if len(full_seg_idx) > 0:
                ...
                # [FIX] seg_median -> seg_mean 으로 통일 (assign_cn_state가 seg_mean을 요구)
                seg_mean = 0.0 if np.isnan(seg_vals).all() else float(np.nanmedian(seg_vals))
                ...
                segments.append({
                    ...
                    "seg_mean": seg_mean   # [FIX] 컬럼명 seg_median -> seg_mean 으로 통일
                })
